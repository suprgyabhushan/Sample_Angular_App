        ...
        return {
            ...
            controller: ["$scope", "$element", "$timeout", function(e, r, a) {
                ...
                i.isUndefined(e.autoplay) || "number" != typeof e.autoplay || (s = i.extend({}, s, {
                    ...
                    //r[0].firstChild.addEventListener('ng-click', preventClick, true);
            ...
            link: function(e, r) {
                var t = e.swiper_uuid,
                    ...
                    o = r[0];
                i.element(o.querySelector(".swiper-pagination")).attr("id", a), i.element(o.querySelector(".overlay")).attr("id", s),i.element(o.querySelector(".swiper-button-next")).attr("id", s), i.element(o.querySelector(".swiper-button-prev")).attr("id", n), i.element(r[0].querySelector(".swiper-scrollbar")).attr("id", l)
            },
            template: '<div class="swiper-container {{containerCls}}"><div class="parallax-bg" data-swiper-parallax="{{parallaxTransition}}" ng-show="parallax"></div><div class="swiper-wrapper {{wrapperCls}}" ng-transclude></div><div class="swiper-pagination {{paginationCls}}"></div><div class="overlay"><div class="swiper-button-next" ng-show="showNavButtons"></div></div><div class="overlay"><div class="swiper-button-prev" ng-show="showNavButtons"></div></div><div class="swiper-scrollbar" ng-show="showScrollBar"></div></div>'
        }
    }
